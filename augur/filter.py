...
def register_arguments(parser):
    ...
    input_group.add_argument('--metadata-index-columns', default=["strain", "name"], nargs="+", help="names of valid metadata columns containing identifier information like 'strain' or 'name'")
...
def run(args):
    ...
    metadata_reader = read_metadata(
        args.metadata,
        valid_index_cols=args.metadata_index_columns,
