...
The input can include a metadata file, a sequences file, or both.

Configuration is provided via a YAML file:
<https://github.com/nextstrain/augur/blob/victorlin/subsample/augur/data/schema-subsample-config.json>
"""
...
def register_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    config_group = parser.add_argument_group("Configuration options", "configuration options")
...
def _add_to_args(args: List[str], filter_flag: AugurFilterOption, value: Any) -> None:
