...
from .argparse_ import InputFile
...
def register_parser(parent_subparsers):
    ...
    parser.add_argument('--alignment', '-a', type=InputFile, required=True, help="alignment in fasta or VCF format")
    ...
    parser.add_argument('--vcf-reference', type=InputFile, help='fasta file of the sequence the VCF was mapped to')
    parser.add_argument('--exclude-sites', type=InputFile, help='file name of one-based sites to exclude for raw tree building (BED format in .bed files, second column in tab-delimited files, or one position per line)')
