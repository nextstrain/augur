...
def filter_by_query(query: str, column_types: Optional[Dict[str, str]] = None) -> FilterFunctionReturn:
...
def filter_by_sequence_length(sequence_index, min_length) -> FilterFunctionReturn:
