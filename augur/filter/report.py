...
def print_report(args):
    ...
    report_template_by_filter_name = {
        ...
        include_exclude_rules.filter_by_sqlite_query.__name__: "{count} {were} filtered out by the SQLite query: \"{query}\"",
        include_exclude_rules.filter_by_pandas_query.__name__: "{count} {were} filtered out by the Pandas query: \"{query}\"",
