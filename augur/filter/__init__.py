...
def register_arguments(parser):
    ...
    input_group.add_argument('--metadata', required=True, metavar="FILE", type=resolvable_filepath, help="sequence metadata")
    input_group.add_argument('--sequences', '-s', type=resolvable_filepath, help="sequences in FASTA or VCF format. For large inputs, consider using --sequence-index in addition to this option.")
    input_group.add_argument('--sequence-index', type=resolvable_filepath, help="sequence composition report generated by augur index. If not provided, an index will be created on the fly. This should be generated from the same file as --sequences.")
    ...
    metadata_filter_group.add_argument('--exclude', type=resolvable_filepath, nargs="+", action=ExtendOverwriteDefault, help=descriptions['exclude'])
    ...
    metadata_filter_group.add_argument('--include', type=resolvable_filepath, nargs="+", action=ExtendOverwriteDefault, help=descriptions['include'])
    ...
    subsample_group.add_argument('--group-by-weights', type=resolvable_filepath, metavar="FILE", help=descriptions['group_by_weights'])
...
def run(args):
    ...
    if args.non_nucleotide:
        print_err("WARNING: --non-nucleotide is deprecated. Use --exclude-invalid instead.")
        args.exclude_invalid = True
