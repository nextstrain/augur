...
def register_arguments(parser):
    ...
    """
    parser.add_argument('--sequences', '-s', required=True, nargs="+", action=ExtendOverwriteDefault, metavar="FASTA", type=resolvable_filepath, help="sequences to align")
    ...
    parser.add_argument('--reference-sequence', metavar="PATH", type=resolvable_filepath, help="Add this reference sequence to the dataset & strip insertions relative to this. Use if the reference is NOT already in the input sequences")
    ...
    parser.add_argument('--existing-alignment', metavar="FASTA", default=False, type=resolvable_filepath, help="An existing alignment to which the sequences will be added. The ouput alignment will be the same length as this existing alignment.")
