...
Usage:
    python scripts/generate_subsample_schema.py
"""
...
def create_schema():
    ...
    schema = {
        "_description": "This file is generated by scripts/generate_subsample_schema.py. Do not edit manually - edit the script instead.",
