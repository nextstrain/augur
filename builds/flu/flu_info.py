...
clade_designations = {
    "h3n2":{
        ...
        "a1":[('HA1',144,'S'), ('HA1',159,'Y'), ('HA1',225,'D'),
        ...
        "3c3.b": [('HA1',83,'R'), ('HA1',261,'Q'), ('HA1',62,'K'),
            ('HA1',122,'D')],
        "a2": [('HA1',159,'Y'), ('HA1',225,'D'), ('HA1',311,'H'),
            ('nuc',1491,'A'), ('nuc',234,'A'), ('HA1',53,'N'),
            ('HA1',144,'R'), ('HA1',171,'K'), ('HA1',192,'T'),
            ('HA1',197,'H')],
        "a3": [('HA1',159,'Y'), ('HA1',225,'D'), ('HA1',311,'H'),
            ('nuc',1491,'A'), ('nuc',234,'A'), ('HA1',121,'K'),
            ('HA1',144,'K')],
        "a4": [('HA1',144,'S'), ('HA1',159,'Y'), ('HA1',225,'D'),
            ('HA1',311,'H'), ('nuc',1491,'A'), ('nuc', 234, 'A'),
            ('HA1',131,'K'), ('HA1',142,'K'), ('HA1',261,'Q')],
        "a1a": [('HA1',144,'S'), ('HA1',159,'Y'), ('HA1',225,'D'),
            ('HA1',311,'H'), ('nuc',1491,'A'), ('nuc', 234, 'G'),
            ('HA2',150,'E'), ('nuc',114,'T')],
        "a1b": [('HA1',159,'Y'), ('HA1',225,'D'), ('nuc',1491,'A'),
