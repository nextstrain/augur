...
class TestSubsampleConfigValidation:
    ...
    def test_invalid_config_both_max_sequences_and_sequences_per_group(self):
        """Test that config with both subsample_max_sequences and sequences_per_group fails validation."""
        config_content = textwrap.dedent("""
            samples:
              test_sample:
                group_by:
    ...
    def test_invalid_config_neither_max_sequences_nor_sequences_per_group(self):
        """Test that config without either subsample_max_sequences or sequences_per_group fails validation."""
        config_content = textwrap.dedent("""
            samples:
              test_sample:
                group_by:
