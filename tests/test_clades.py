...
def test_read_in_clade_definitions_simple():
    ...
    assert clades['Clade_1'] == [('ctpE', 80, 'D')]
    assert clades['Clade_2'] == [('nuc', 30641, 'T')]
    assert clades['Clade_3'] == [('nuc', 444295, 'A'), ('pks8', 633, 'T')]
...
def test_read_in_clade_definitions_inherit_simple():
    ...
    assert clades['Clade_1'] == [('ctpE', 80, 'D')]
    assert clades['Clade_2'] == [('nuc', 30641, 'T')]
    assert clades['Clade_3'] == [('nuc', 30641, 'T'), ('pks8', 633, 'T')]
...
def test_read_in_clade_definitions_inherit_chained():
    ...
    assert clades['Clade_1'] == [('ctpE', 80, 'D')]
    assert clades['Clade_2'] == [('ctpE', 80, 'D'),('nuc', 30641, 'T')]
    assert clades['Clade_3'] == [('ctpE', 80, 'D'),('nuc', 30641, 'T'), ('pks8', 633, 'T')]
