...
Build a tree with offending characters, and ensure characters are not overwritten and warning is printed.
  ...
  WARNING: Potentially offending character '@' detected in taxon name '1_0181_PF/@United-Arab-Emirates'.  We recommend replacing offending characters with '_' in the alignment file to avoid issues downstream.
