...
Test single gene reconstruction with a (AA) root-sequence
  ...
  >  --genes ENV \
  >  --translations $TESTDIR/../data/aa_sequences_ENV.fasta \
  >  --root-sequence $TESTDIR/../data/ENV_outgroup.fasta \
  >  --seed 314159 \
...
Test that accidentally providing the wrong root-sequence (e.g. a nuc one) results in an error
