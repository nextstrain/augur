  ...
  Validating schema of 'duplicate-nodes.json'...
    .tree {"name": "root", "node_attrs": {"div": 0, "num_d…} is invalid, see below.
      validation for arm 0: {"$ref": "#/$defs/tree"}
        ...
        .tree.children[1].node_attrs.num_date 2023.2 failed: 2023.2 is not of type 'object'
      ...
      validation for arm 1: {"type": "array", "minItems": 1, "items": {"$ref": "#/$defs/tree"}}
        .tree {"name": "root", "node_attrs": {"div": 0, "num_d…} failed: {'name': 'root', 'node_attrs': {'div': 0, 'num_date': 2023.0}, 'children': [{'name': 'duplicate', 'node_attrs': {'div': 0.1, 'num_date': 2023.1}}, {'name': 'duplicate', 'node_attrs': {'div': 0.2, 'num_date': 2023.2}}]} is not of type 'array'
  ...
  Validating schema of 'missing-coloring-ref.json'...
    ...
    .tree {"name": "root", "node_attrs": {"div": 0, "num_d…} is invalid, see below.
      validation for arm 0: {"$ref": "#/$defs/tree"}
        ...
        .tree.node_attrs.num_date 2023.0 failed: 2023.0 is not of type 'object'
      validation for arm 1: {"type": "array", "minItems": 1, "items": {"$ref": "#/$defs/tree"}}
        .tree {"name": "root", "node_attrs": {"div": 0, "num_d…} failed: {'name': 'root', 'node_attrs': {'div': 0, 'num_date': 2023.0}, 'children': [{'name': 'child1', 'node_attrs': {'div': 0.1, 'num_date': 2023.1}}]} is not of type 'array'
