...
1. ISO 8601 format with unknown parts explicitly masked by ``XX``
   (e.g. ``2018-03-XX``, ``2018-XX-XX``)
2. `ISO 8601 interval formats <https://en.wikipedia.org/wiki/ISO_8601#Time_intervals>__`
